...
class CompletedOrdersByChef extends StatefulWidget {
  const CompletedOrdersByChef({Key? key}) : super(key: key);

  @override
  State<CompletedOrdersByChef> createState() => _CompletedOrdersByChefState();
}
...
class _CompletedOrdersByChefState extends State<CompletedOrdersByChef> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: orderController.getCompletedOrdersByChef(),
